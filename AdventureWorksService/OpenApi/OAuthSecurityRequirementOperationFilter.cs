...
namespace AdventureWorksService.WebApi.OpenApi
{
    /// <summary>
    ...
    internal class OAuthSecurityRequirementOperationFilter : IOperationFilter
    {
        ...
        public OAuthSecurityRequirementOperationFilter(IOptions<AzureAdConfig> azureAdConfig)
        {
            _appIdUri = azureAdConfig.Value.Audience;
        }
